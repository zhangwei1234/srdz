...
create table web_advertising(
	...
	image_url	varchar(1000)	not null			comment '广告图片地址',
	link_url	varchar(1000)	not null			comment '广告链接地址',
...
create table web_group (
	...
	icon_url	varchar(1000) not null	comment	'icon地址',
...
create table web_user_feedback(
	...
	comment		varchar(400)    not null	comment '反馈内容',
	status		int(1)		not null	default -1 comment '状态(-1:未处理,1:已经处理)',
	createTime	datetime	not null	comment '创建时间',
	operate_user varchar(50) 	null		comment '处理人账号',
	updateTime	datetime	null		comment '处理时间',
    operateComment	varchar(500) null  comment '处理内容',
	primary key (id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table web_user_message(
	id		int(11)		not null	AUTO_INCREMENT,
	userAccount	varchar(50)	not null	comment	'用户账号',
	comment		varchar(400)    not null	comment '消息内容',
	status		int(1)		not null	default -1 comment '状态(-1:未处理,1:已经处理)',
	createTime	datetime	not null	comment '创建时间',
	updateTime	datetime	null		comment '处理时间',
	primary key (id)
